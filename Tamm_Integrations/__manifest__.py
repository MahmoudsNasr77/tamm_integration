# -*- coding: utf-8 -*-
{
    ...
    'images': [
        'Tamm_Integrations/static/description/cover.png',
        ...
        'Tamm_Integrations/static/description/5.png',
        'Tamm_Integrations/static/description/6.png',
        'Tamm_Integrations/static/description/7.png',
        'Tamm_Integrations/static/description/8.png',
        'Tamm_Integrations/static/description/9.png',
        'Tamm_Integrations/static/description/10.png',
        'Tamm_Integrations/static/description/11.png',
        'Tamm_Integrations/static/description/12.png',
        'Tamm_Integrations/static/description/13.png',
        'Tamm_Integrations/static/description/14.png',
    ],
